...
import '../modules/home_screen/fragments/news_fragment/news_fragment.dart';
...
class AppRoutes {
  ...
  static Page _homeScreenBuilder(BuildContext context, GoRouterState state) {
    User user = state.extra as User? ?? User(
      id: 002,
      name: "tongcopasguys",
      username: "murnilkel3",
      email: "murnikel3@kadeayacakcak.com",
      profilePhoto:
          "https://cdn-brilio-net.akamaized.net/news/2020/05/08/184074/1223821-8-penampakan-tokoh-upin-ipin-jadi-jamet.jpg",
