  ...
  class AppRoutes {
    ...
    static Page _homeScreenBuilder(
        BuildContext context, GoRouterState state) {
      User user =
          state.extra as User? ?? User(id: 002, name: "tongcopasguys", email: '', username: '');
      return MaterialPage(
        child: HomeScreen(
          user: user,
        ),
    ...
    GoRouterState state,
      ...
      final imagePath = state.params['imagePath'];
      
      return MaterialPage(
        child: NewsDetailScreen(
          id: id ?? '1', // menggunakan nilai default jika tidak ada id yang diberikan
          title: title!,
          content: content!,
          imagePath: imagePath!,
        )
